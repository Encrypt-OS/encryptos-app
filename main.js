...
function createWindow() {
  ...
  loadingScreen.loadFile("./src/pages/noperms.html");
}
}
...
function createloginWindow() {
  ...
  ipcMain.on('login_sar', () => {loginWindow.show(); loginWindow.loadURL("https://login.snaildos.com?redir=encryptos://login"); loginWindow.maximize(); ipcMain.emit('main_hide')})
  ...
  loginWindow.loadURL("https://login.snaildos.com?redir=encryptos://login");
}
app.whenReady().then(() => {
  ...
  app.setAsDefaultProtocolClient("encryptos");
  protocol.registerHttpProtocol('encryptos', (req, cb) => {
